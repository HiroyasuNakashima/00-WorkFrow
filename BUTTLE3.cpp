...
void BUTTLE3::init(CONTAINER* c, AITEM_WINDOW* a) {
	BackImg = c->buttleBackImg;
	MonsterImg = c->buttleMonster3Img;
	...
	MonsterLife = c->monster3Life;
	MonsterAttckDamege = c->monster3AttckDamege;
...
void BUTTLE3::update(AITEM_WINDOW* a) {
...
void BUTTLE3::draw() {
	...
	if (TextFlag == 3) {
		text("モンスターの攻撃　48のダメージ", TextPx1, TextPy1);
	}
	if (TextFlag == 4) {
...
int BUTTLE3::playerWin() { return PlayerWin; }
int BUTTLE3::playerLose() { return PlayerLose; }
int BUTTLE3::playerEscape() { return PlayerEscape; }